...
class InitialDataSeederCopy extends Seeder
{
    public function run(): void
    {
        ...
        // =========================================================
        $permissios = ["users.manage", "users.assign", "users.create", "users.edit", "users.view", "roles.manage", "roles.assign", "settings.manage", "settings.view", "settings.update"];
        //note - ei permissions take role create korar somoy permission diye dibe permissions table ei role create korte hobe - json - permissions field
